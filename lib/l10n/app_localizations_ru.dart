...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get animirovannyeUvedomleniyaSBystrymOtvetom_a25d =>
      'Анимированные уведомления с быстрым ответом';
  @override
  ...
  @override
  String get obIspolzovaniiParolya_9739 => 'Об использовании пароля';
  @override
  String get parolTolkoDlyaAvariynogoVhoda_b142 =>
      'Пароль используется только в крайнем случае — если не удастся войти с помощью кода из бота «Уведомления Xaneo» или кода из письма на почту.';
  @override
  ...
  String get qrScanConfirmDesc =>
      'На другом устройстве запрошен вход в ваш аккаунт. Сверьте короткий код и подтвердите действие.';

  @override
  String get qrScanSecurityNote =>
      'Продолжайте только если QR-код открыт на устройстве, которым вы управляете.';

  @override
  String get qrScanDoneButton => 'Готово';

  @override
  String get authNotificationSendingCode => 'Отправляем код';

  @override
  String get authNotificationEnterCode => 'Введите код';

  @override
  String get authNotificationConfirmLogin => 'Подтвердите вход';
  ...
  @override
  String get authRejectedTitle => 'Вход отклонён';

  @override
  String get authRejectedDesc =>
      'Запрос на авторизацию был отклонён на другом устройстве. Если это были не вы, рекомендуем проверить безопасность аккаунта.';

  @override
  String get authRejectedButton => 'Понятно';
  ...
  @override
  String get deviceAuthApprovalAllow => 'Разрешить вход';

  @override
  String get deviceAuthApprovalDecline => 'Отклонить';

  @override
  String get deviceAuthDevice => 'Устройство';

  @override
  String get deviceAuthApp => 'Приложение';

  @override
  String get deviceAuthIp => 'IP-адрес';
